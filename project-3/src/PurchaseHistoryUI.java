...
//    public JTextField txtAddress = new JTextField(20);
    ...
    public PurchaseHistoryUI(UserModel user) {
        ...
        PurchaseListModel list = javaApp.getInstance().getDataAdapter().loadPurchaseHistory(user.mCustomerID);
        ...
        for (PurchaseModel purchase : list.purchases) {
            ...
            ProductModel product = javaApp.getInstance().getDataAdapter().loadProduct(purchase.mProductID);
            row[2] = product.name;
